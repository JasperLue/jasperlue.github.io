var Instagram = (function(){
	...
	var render = function(data){
		for(var em in data){
			...
			for(var i=0,len=data[em].srclist.length;i<len;i++){
				liTmpl += '<li>\
								<div class="img-box">\
									<a class="img-bg" rel="example_group" href="/instagram/2012/6/2012-06-07_1339032493.jpg" title="'+data[em].text[i]+'"></a>\
	...
	return {
		init:function(){
			//getList("s://api.instagram.com/v1/users/438522285/media/recent/?access_token=438522285.2082eef.ead70f432f444a2e8b1b341617637bf6&count=100");
